...
namespace moviecruiser
{
    class Program
    {
        static void Main()
        {
            ...
            {
                {1,new Customer(1,"gowthami") },
                {2,new Customer(2,"Sowmya") },
                {3,new Customer(3,"akshitha") },
                {4,new Customer(4,"vyshnavi") },
                {5,new Customer(5,"srinu") }
            };
            ...
            try
            {
                if (userType == 1)
                {
                    ...
                    if ((admin.AdminName == "gowthami") && (admin.AdminPassword == "sowmya"))
                    {
                        int flag = 1;
